...
<div class="mycart w990 mt10 bc">
    ...
    <?php foreach($goods as $goods):?>
        <tr data-id="<?=$goods->id?>">
            <td class="col1"><a href=""><img src="<?='http://www.adminshop.com'.$goods->logo?>" /></a>  <strong><a href=""><?=$goods->name?></a></strong></td>
...
//            console.log(goods_id);
            var that = this;
            $.post("/goods/ajax-cart?type=del",{goods_id:goods_id},function(data) {
                if(data ==1){

            ...
            <div class="cat_bd none">
                ...
                <div class="cat">
                    ...
                    <div class="cat_detail">
                        ...
                        <?php foreach($value->goods as $item):?>
                        <dl class="dl_1st">

                            <dt><a href=""><?=$item->name?></a></dt>
                            <dd>
                              <?php foreach($item->goods as $v):?>
                                <a href=""><?=$v->name?></a>
                             <?php endforeach;?>
...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl id="<?=$list->id?>">
                <dt><?=$list->id.'.'.'&emsp;'.$list->name.'&emsp;'.  $list->province.'&emsp;'.($list->city=='市辖区'?'':$list->city).'&emsp;'.$list->area.'&emsp;'.$list->detail?></dt>
                <dd>
                    <a href="<?=yii\helpers\Url::to(['address/edit','id'=>$list->id])?>">修改</a>
        ...
        <div class="address_bd mt10">
            <h4>新增收货地址</h4>
            <form action=""id="myform" name="address_form" method="post">
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" id="detail" name="detail" class="txt address"  />
                    </li>
                    <li>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="submit" id="btn" name="" class="btn" value="保存" />
                    </li>
                </ul>
            </form>
        </div>
...
<script>
    $("#btn").click(function () {
        $.post('<?=yii\helpers\Url::to(['address/add'])?>',$("#myform").serialize());

  });

    $('.address_hd').on('click','#dels',function() {
        ...
        if(confirm('是否删除')){
           ...
           console.log(id);
            ...
            $.post('<?=yii\helpers\Url::to(['address/del'])?>',{id:id},function(data) {
                if(data ==1){
